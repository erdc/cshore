C     
C     2014 CSHORE: Rolando ; 2014 February 12
C      #######    #######   ##    ##     ######    #######    ########
C     ##         ##         ##    ##    ##    ##   ##    ##   ##
C     ##         ##         ##    ##    ##    ##   ##    ##   ##
C     ##         #######    ########    ##    ##   #######    #######
...
C     
      ...
      CHARACTER FINMIN*12, VER*70 !bdj
...
C     ------------------------------------------------------------------
      VER = 'CSHORE USACE version 2014, merged on 2015-03-12  ' !bdj
...
C     
      SUBROUTINE OPENER(FINMIN)
C     
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      CHARACTER*12 FINMIN
C     
      OPEN(UNIT=11,FILE=FINMIN,  STATUS='OLD',    ACCESS='SEQUENTIAL')
      ...
      OPEN(UNIT=39,FILE='ODIKER',STATUS='UNKNOWN',ACCESS='SEQUENTIAL')
