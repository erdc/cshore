...
LeveeProfile = load ('LeveeProfile_SteepSlope.txt') ;
...
legend ('H_{rms} (m)', 'location', 'northwest')

idtmp = find (results.hydro.x>=260) ;
Hrmstoe = results.hydro.Hrms (idtmp(1)) ; 
if in.iveg==0
    text (180, 3.5, ['no veg: H_{rms, 0} = ', num2str(in.Hrms), ' (m)'], 'fontsize', 15) ; 
    text (180, 2.8, ['Qos = ', num2str(qosmodel), ' (cm^2/s)'], 'fontsize', 15) ; 
    text (180, 2.1, ['R2%= ', num2str(results.hydro.runup_2_percent), ' (m)'], 'fontsize', 15) ; 
    text (180, 1.4, ['H_{rms, toe} = ', num2str(Hrmstoe), ' (m)'], 'fontsize', 15) ; 
elseif in.iveg==1
    text (230, 3.5, ['w/ veg (iveg=1): H_{rms, 0} = ', num2str(in.Hrms), ' (m)'], 'fontsize', 15) ; 
    text (230, 2.8, ['Qos = ', num2str(qosmodel), ' (cm^2/s)'], 'fontsize', 15) ; 
    text (230, 2.1, ['R2%= ', num2str(results.hydro.runup_2_percent), ' (m)'], 'fontsize', 15) ; 
    text (230, 1.4, ['H_{rms, toe} = ', num2str(Hrmstoe), ' (m)'], 'fontsize', 15) ; 
elseif in.iveg==3
    text (130, 3.5, ['w/ veg (iveg=3): H_{rms, 0} = ', num2str(in.Hrms), ' (m)'], 'fontsize', 15) ; 
    text (130, 2.8, ['Qos = ', num2str(qosmodel), ' (cm^2/s)'], 'fontsize', 15) ; 
    text (130, 2.1, ['R2%= ', num2str(results.hydro.runup_2_percent), ' (m)'], 'fontsize', 15) ; 
    text (130, 1.4, ['H_{rms, toe} = ', num2str(Hrmstoe), ' (m)'], 'fontsize', 15) ; 
end    
