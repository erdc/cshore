...
%     in.swlbc = 0*dum;    % water level at seaward boundary in meters zb         
    ...
    fric_fac_rough = 0.5;     % bottom friction factor for permeable cobbles
...
if vegtest ==1 
    plot (Qosmodel_revetment, qosmodel, 'or', 'markersize', 10, 'linewidth', 2)
else
   plot (Qosmodel_revetment, qosmodel, '+b', 'markersize', 10, 'linewidth', 2)
end
...
legend ('Test 1', 'Test 2', 'fontsize', 15)
axis equal
xlim ([0, 60])
ylim ([0, 60])
