...
%     in.zb     = interp1(x_b, zb, in.x); 
    ...
    if vegtest ==1
        in.veg_extent = [6.3/Lx, (6.3+0.82+1.24)/Lx] ;
    else 
        in.veg_extent = [1.96/Lx, (6.3+0.82+1.24)/Lx]; 
    end 
...
xlim ([0, 0.15])
ylim ([0, 0.15])
xlabel ('H_{rms} at toe using revetment (Test 0) (m)')
ylabel ('H_{rms} at toe using vegetation (Test 1 & 2) (m)')
set (gca, 'fontsize', 15)
set(gca,'linewidth',2)
